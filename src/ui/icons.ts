...
/** Two opposed arrows — reverse a route's direction. */
export const iconReverse = svg(
...
/** Activity pulse line — track viewer / analysis. */
...
/** Circle with question mark / info-help. */
