...
const DISPLAY: Record<string, DisplayMeta> = {
  ...
  "southern-new-england": {
    sizeEstimate: 150 * 1024 * 1024,
    basemapSizeEstimate: 188 * 1024 * 1024,
    center: [-71.5, 41.5],
    defaultZoom: 11,
  },
  "new-york": {
    sizeEstimate: 200 * 1024 * 1024,
    basemapSizeEstimate: 300 * 1024 * 1024,
    center: [-73.8, 40.4],
    defaultZoom: 10,
  },
  "mid-atlantic": {
    sizeEstimate: 250 * 1024 * 1024,
    basemapSizeEstimate: 311 * 1024 * 1024,
    center: [-76.0, 37.5],
    defaultZoom: 9,
  },
  "south-atlantic": {
    sizeEstimate: 400 * 1024 * 1024,
    basemapSizeEstimate: 451 * 1024 * 1024,
    center: [-80.0, 30.0],
    defaultZoom: 8,
  },
  usvi: {
    sizeEstimate: 24 * 1024 * 1024,
    basemapSizeEstimate: 36 * 1024 * 1024,
    center: [-64.930893, 18.335314],
    defaultZoom: 12,
  },
  "gulf-coast": {
    sizeEstimate: 500 * 1024 * 1024,
    basemapSizeEstimate: 626 * 1024 * 1024,
    center: [-88.0, 28.5],
    defaultZoom: 7,
  },
  "great-lakes": {
    sizeEstimate: 400 * 1024 * 1024,
    basemapSizeEstimate: 542 * 1024 * 1024,
    center: [-84.0, 45.0],
    defaultZoom: 6,
  },
  "ny-inland": {
    sizeEstimate: 75 * 1024 * 1024,
    basemapSizeEstimate: 97 * 1024 * 1024,
    center: [-76.5, 43.0],
    defaultZoom: 8,
  },
  washington: {
    sizeEstimate: 90 * 1024 * 1024,
    basemapSizeEstimate: 168 * 1024 * 1024,
    center: [-122.45, 47.6],
    defaultZoom: 9,
  },
  oregon: {
    sizeEstimate: 60 * 1024 * 1024,
    basemapSizeEstimate: 100 * 1024 * 1024,
    center: [-124.0, 44.5],
    defaultZoom: 8,
  },
  "northern-california": {
    sizeEstimate: 25 * 1024 * 1024,
    basemapSizeEstimate: 20 * 1024 * 1024,
    center: [-123.8, 39.8],
    defaultZoom: 8,
  },
  "central-california": {
    sizeEstimate: 50 * 1024 * 1024,
    basemapSizeEstimate: 142 * 1024 * 1024,
    center: [-122.45, 37.78],
    defaultZoom: 10,
  },
  "southern-california": {
    sizeEstimate: 45 * 1024 * 1024,
    basemapSizeEstimate: 120 * 1024 * 1024,
    center: [-118.4, 33.7],
    defaultZoom: 10,
  },
  hawaii: {
    sizeEstimate: 50 * 1024 * 1024,
    basemapSizeEstimate: 8 * 1024 * 1024,
    center: [-157.85, 21.3],
    defaultZoom: 8,
  },
};
