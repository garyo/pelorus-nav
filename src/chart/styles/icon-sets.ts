...
const S52_OFFSETS: Record<string, [number, number]> = {
  // Buoys — SVG pivots are at waterline; small S-52 offsets only
  BOYLAT13: [0, 0],
  BOYLAT14: [0, 0],
  BOYLAT23: [0, 0],
  BOYLAT24: [0, 0],
  ...
  // co-located buoy/beacon so it's visible. Hand-tuned — keep as-is.
  LIGHTS11: [12, 12],
  LIGHTS12: [12, 12],
  LIGHTS13: [12, 12],
  // Hazards
  ...
  TOPMAR25: [0, 0],
  TOPMAR65: [0, 0],
  // Landmarks — SVG pivots are at base midpoint; zero ML offset
  TOWERS01: [0, 0],
  TOWERS02: [0, 0],
  TOWERS03: [0, 0],
  TOWERS05: [0, 0],
