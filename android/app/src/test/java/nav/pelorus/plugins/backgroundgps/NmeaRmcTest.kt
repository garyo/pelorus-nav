...
class NmeaRmcTest {
    ...
    @Test
    fun `rejects NaN minutes and out-of-range degrees`() {
        // NaN passes naive range guards and reads as "inside the ring".
        assertNull(parseNmeaRmc(withChecksum("GPRMC,123519,A,48NaN,N,01131.000,E,0,0,230394,,")))
        assertNull(parseNmeaRmc(withChecksum("GPRMC,123519,A,9907.038,N,01131.000,E,0,0,230394,,")))
        assertNull(parseNmeaRmc(withChecksum("GPRMC,123519,A,4807.038,N,18131.000,E,0,0,230394,,")))
    }
